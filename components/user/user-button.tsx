'use client';
import WithdrawDialog from '@/components/auth/withdraw-dialog';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
export default function UserButton({ user }: UserButtonProps) {
  ...
  const [dialogOpen, setDialogOpen] = useState<'withdraw' | null>(null);
  ...
  return (
    <>
      ...
      >
        {dialogOpen === 'withdraw' && <WithdrawDialog />}
      </Dialog>
    </>
  );
}

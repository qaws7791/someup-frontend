...
export const typography = cva('', {
  variants: {
    scale: {
      'head-1': 'text-5xl font-semibold leading-1.1 tracking-wider',
      'head-2': 'text-4xl font-semibold leading-1.3 tracking-wider',
      'title-1': 'text-3xl font-semibold leading-1.3 tracking-normal',
      'title-2': 'text-2xl font-semibold leading-1.4 tracking-normal',
      'title-3': 'text-xl font-semibold leading-1.5 tracking-normal',
      'title-4': 'text-lg font-semibold leading-1.5 tracking-normal',
